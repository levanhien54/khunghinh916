...
- 🧱 Kiến trúc phân lớp, **105 unit test** cho phần logic, **logging** ra file để debug.
...
```bash
python -m pytest          # 105 unit test: geometry, smoothing, tracking, ASD, camera path,
...
└── tests/                      # 105 test cho toàn bộ core/ + detection/ + tracking/
```
